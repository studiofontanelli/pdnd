/**
 * ParametriCalcoloTassaDatiTecnici.java
 *
...
public class ParametriCalcoloTassaDatiTecnici  implements java.io.Serializable {
    private it.csi.staris.pdnd.integration.service.starissrv.stub.Mittente mittente;

    public ParametriCalcoloTassaDatiTecnici() {
    }
    ...
    /**
     * Gets the mittente value for this ParametriCalcoloTassaDatiTecnici.
     * 
     * @return mittente
     */
    ...
    /**
     * Sets the mittente value for this ParametriCalcoloTassaDatiTecnici.
     * 
     * @param mittente
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParametriCalcoloTassaDatiTecnici)) return false;
        ParametriCalcoloTassaDatiTecnici other = (ParametriCalcoloTassaDatiTecnici) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParametriCalcoloTassaDatiTecnici.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://serviziorissrv.interfacews.starissrv.staris.csi.it/", "parametriCalcoloTassaDatiTecnici"));
