...
public class Regione  implements java.io.Serializable {
    ...
    /**
     * Gets the codice value for this Regione.
     * 
     * @return codice
     */
    ...
    /**
     * Sets the codice value for this Regione.
     * 
     * @param codice
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://serviziorissrv.interfacews.starissrv.staris.csi.it/", "regione"));
