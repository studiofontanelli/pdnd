 ...
 */
@Component
public class TargaAdapterImpl extends CommonDtoAdapter<String, Targa> implements TargaAdapter{
	...
	@Override
	public Targa convertTo(String t) throws DtoConversionException {
	...
	@Override
	public String convertFrom(Targa v) throws DtoConversionException {
