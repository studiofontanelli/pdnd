...
import it.csi.staris.starissrv.dto.serviziorissrv.TipoRiduzione;
 ...
 */
@Component
public class TipoRiduzioneAdapterImpl extends CommonDtoAdapter<String, TipoRiduzione> implements TipoRiduzioneAdapter{
	...
	@Override
	public TipoRiduzione convertTo(String t) throws DtoConversionException {
		final String method = "convertTo";
		try {
			if(t == null)
				return null;
			TipoRiduzione tipoRiduzione = new TipoRiduzione();
			tipoRiduzione.setCodice(t);
	...
	@Override
	public String convertFrom(TipoRiduzione v) throws DtoConversionException {
