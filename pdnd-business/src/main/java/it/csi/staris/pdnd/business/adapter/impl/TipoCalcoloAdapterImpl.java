...
import it.csi.staris.starissrv.dto.serviziorissrv.TipoCalcolo;
 ...
 */
@Component
public class TipoCalcoloAdapterImpl extends CommonDtoAdapter<String, TipoCalcolo> implements TipoCalcoloAdapter{
	...
	@Override
	public TipoCalcolo convertTo(String t) throws DtoConversionException {
		final String method = "convertTo";
		try {
			if(t == null)
				return null;
			TipoCalcolo tipoCalcolo = new TipoCalcolo();
			tipoCalcolo.setCodice(t);
			return tipoCalcolo;
		}catch(Exception e) {
	...
	@Override
	public String convertFrom(TipoCalcolo v) throws DtoConversionException {
