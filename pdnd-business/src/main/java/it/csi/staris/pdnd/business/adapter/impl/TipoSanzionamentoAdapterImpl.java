...
import it.csi.staris.starissrv.dto.serviziorissrv.TipoSanzionamento;
 ...
 */
@Component
public class TipoSanzionamentoAdapterImpl extends CommonDtoAdapter<String, TipoSanzionamento> implements TipoSanzionamentoAdapter{
	...
	@Override
	public TipoSanzionamento convertTo(String t) throws DtoConversionException {
		final String method = "convertTo";
		try {
			if(t == null)
				return null;
			TipoSanzionamento tipoSanzionamento = new TipoSanzionamento();
			tipoSanzionamento.setCodice(t);
	...
	@Override
	public String convertFrom(TipoSanzionamento v) throws DtoConversionException {
