...
public class Tracer implements Serializable{
	...
	public static void debug(Logger logger, String className, String methodName, Object obj)  {
		if(logger != null){
			if (logger.isDebugEnabled())  logger.debug(createOutput(className,methodName,obj));
		}
	}
	...
	public static void info(Logger logger, String className, String methodName, Object obj) {
		if(logger != null){
			if (logger.isInfoEnabled()) {
				logger.info(createOutput(className,methodName,obj));
			}
		}
	}
	...
	private static String createOutput(String className, String methodName, Object obj){
